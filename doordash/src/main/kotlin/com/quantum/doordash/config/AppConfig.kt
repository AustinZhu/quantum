...
data class AppConfig(
    ...
    val dbSchema: String,
    val redisUrl: String,
    val redpandaBrokers: String,
    val redpandaOrderTopic: String,
    val redpandaRiskTopic: String,
...
fun loadConfig(): AppConfig {
    val config = AppConfig(
        ...
        redpandaBrokers = System.getenv("DOORDASH_REDPANDA_BROKERS") ?: (System.getenv("REDPANDA_BROKERS") ?: ""),
        redpandaOrderTopic = System.getenv("DOORDASH_REDPANDA_ORDER_TOPIC") ?: "doordash.orders",
        redpandaRiskTopic = System.getenv("DOORDASH_REDPANDA_RISK_TOPIC") ?: "doordash.risk",
        ...
        openapiSpecPath = System.getenv("DOORDASH_OPENAPI_SPEC_PATH") ?: "/app/openapi/quantum.openapi.json",
